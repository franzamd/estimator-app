var app = (function () {
    ...
    // (54:4) {#each materials as material (material.id)}
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			thead.innerHTML = `<tr class="svelte-ckio7v"><th>Material</th> 
      <th>Price</th> 
      <th></th></tr>`;
    			...
    			t8 = text(t8_value);
    			attr(td1, "colspan", "2");
    			attr(tr1, "class", "svelte-ckio7v");
    			attr(table, "class", "primary svelte-ckio7v");
    		},
    		m(target, anchor) {
